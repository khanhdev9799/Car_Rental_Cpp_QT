...
void CreateRide::on_submitBtn_clicked()
{
    ...
    {
        CustomMessageBox messageBox("Không được để trống!");
    ...
    {
        CustomMessageBox messageBox("Công suất động cơ không hợp lệ!");
        int result = messageBox.exec();
        if (result == QMessageBox::Ok) {
            messageBox.close();
        }
    ...
    {
        CustomMessageBox messageBox("Giá không hợp lệ!");
        int result = messageBox.exec();
        if (result == QMessageBox::Ok) {
            messageBox.close();
        }
    ...
    {
        CustomMessageBox messageBox("Số chỗ ngồi không hợp lệ!");
        int result = messageBox.exec();
        if (result == QMessageBox::Ok) {
            messageBox.close();
        }
    ...
    else
    {
        ...
        else
        {
            ...
            {
                CustomMessageBox messageBox("Đã thêm xe thành công!");
                int result = messageBox.exec();
                if (result == QMessageBox::Ok) {
                    messageBox.close();
                }
...
void CreateRide::GetData()
{
    ...
    CarPrice = "$"+ui->carPrice->text().trimmed() + "/Ngày";
}
